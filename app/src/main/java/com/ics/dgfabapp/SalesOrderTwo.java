...
public class SalesOrderTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String text1 = "<font color=#000000>Order No :</font> <font color=#FF929191>000012</font>";
        orderNo.setText(Html.fromHtml(text1));

        orderDt = (TextView) findViewById(R.id.orderDt);
        String text2 = "<font color=#000000>Order Date/Time :</font> <font color=#FF929191>01-05-2019, 8 PM</font>";
        orderDt.setText(Html.fromHtml(text2));

        prepareOrder = (TextView) findViewById(R.id.prepareOrder);
        String text3 = "<font color=#000000>Preparing Order :</font> <font color=#FF929191>John</font>";
        ...
        String text12 = "<font color=#000000>Order No :</font> <font color=#FF929191>000013</font>";
        orderNo1.setText(Html.fromHtml(text12));

        orderDt1 = (TextView) findViewById(R.id.orderDt1);
        String text21 = "<font color=#000000>Order Date/Time :</font> <font color=#FF929191>01-05-2019, 8 PM</font>";
        orderDt1.setText(Html.fromHtml(text21));

        prepareOrder1 = (TextView) findViewById(R.id.prepareOrder1);
        String text31 = "<font color=#000000>Preparing Order :</font> <font color=#FF929191>John</font>";
