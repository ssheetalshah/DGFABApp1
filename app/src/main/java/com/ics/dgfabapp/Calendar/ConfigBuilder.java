...
public class ConfigBuilder {
    ...
    com.ics.dgfabapp.Calendar.Model.HorizontalCalendarConfig createConfig() {
    ...
    com.ics.dgfabapp.Calendar.Model.CalendarItemStyle createDefaultStyle() {
        return new CalendarItemStyle(colorTextTop, colorTextMiddle, colorTextBottom, null);
    }

    com.ics.dgfabapp.Calendar.Model.CalendarItemStyle createSelectedItemStyle() {
